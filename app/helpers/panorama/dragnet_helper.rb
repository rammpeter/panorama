...
include Panorama::Dragnet::OptimalIndexStorageHelper
include Panorama::Dragnet::UnnecessaryIndexesHelper
include Panorama::Dragnet::IndexPartitioningHelper
include Panorama::Dragnet::UnusedTablesHelper
include Panorama::Dragnet::SqlsPotentialDbStructuresHelper
include Panorama::Dragnet::OptimizableFullScansHelper
include Panorama::Dragnet::ProblemsWithParallelQueryHelper
include Panorama::Dragnet::UnnecessaryExecutionsHelper
include Panorama::Dragnet::UnnecessaryHighExecutionFrequencyHelper
include Panorama::Dragnet::SuboptimalIndexUsageHelper
include Panorama::Dragnet::SqlsWrongExecutionPlanHelper
include Panorama::Dragnet::DragnetSqlsTuningSgaPgaHelper
include Panorama::Dragnet::SqlsCursorRedundanciesHelper
include Panorama::Dragnet::DragnetSqlsLogwriterRedoHelper
include Panorama::Dragnet::CascadingViewsHelper
include Panorama::Dragnet::SqlsConclusionApplicationHelper
include Panorama::Dragnet::PlSqlUsageHelper

module Panorama::DragnetHelper
  ...
  def dragnet_sql_list
    if @@dragnet_internal_list.nil? || @@dragnet_list_language != get_locale
      ...
      if defined?(Panorama)                                                     # not for generate_dragnet_html.rb
        ...
        predefined_filename = "#{Panorama::EngineConfig.config.panorama_var_home}/predefined_dragnet_selections.json"
