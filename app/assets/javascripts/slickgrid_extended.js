...
// Name der Spalte, die ein/ausgeschalten wird
    plot_slickgrid_diagram = function(table_id, plot_area_id, caption, column_id, multiple_y_axes, show_y_axes) {
        var options = this.grid.getOptions;
        var columns = this.grid.getColumns();                          // JS-Objekt mit Spalten-Struktur gespeichert an DOM-Element, Originaldaten des Slickgrid, daher kein Speichern nötig
        var data    = this.grid.getData().getItems();                  // JS-Aray mit Daten-Struktur gespeichert an DOM-Element, Originaldaten des Slickgrid, daher kein Speichern nötig
