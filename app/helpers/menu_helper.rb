    ...
    main_menu = [
        {class: 'menu', caption: t(:menu_dba_caption, :default => 'DBA general'), content: [
            ...
            {:class => 'menu', :caption => 'User management', :content => [
              ...
              {:class => 'item', :caption => 'Gradual password rollover', :controller => :dba_schema, :action => :show_gradual_password_rollover, :hint => t(:menu_dba_schema_list_profiles_hint, :default => "Show users in password rollover interval\nMay last longer because it scans Unified_Audit_Trail"), min_db_version: '19.12'},
            ]
            },
