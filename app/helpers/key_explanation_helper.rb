...
module KeyExplanationHelper
  ...
  STATISTIC_DESC = {
    "application wait time" => "The total wait time (in centiseconds) for waits that belong to the Application wait class",
    ...
    "change write time" => "Elapsed redo write time for changes made to CURRENT blocks in 10s of milliseconds.",
    ...
    "cluster wait time" => "The total wait time (in centiseconds) for waits that belong to the Cluster wait class",
    ...
    "concurrency wait time" => "The total wait time (in centiseconds) for waits that belong to the Concurrency wait class",
    ...
    "global enqueue CPU used by this session" => "Amount of CPU time (in 10s of milliseconds) used by synchronous and asynchronous global enqueue activity in a session from the time a user call starts until it ends. If a user call completes within 10 milliseconds, the start and end user-call time are the same for purposes of this statistics, and 0 milliseconds are added.",
    "global enqueue get time" => "Total elapsed time in 10s of milliseconds of all synchronous and asynchronous global enqueue gets and converts",
    ...
    "redo log space wait time" => "Total time waited in centiseconds for available space in the redo log buffer. See also\"redo log space requests\"",
    ...
    "user I/O wait time" => "The total wait time (in centiseconds) for waits that belong to the User I/O wait class",
