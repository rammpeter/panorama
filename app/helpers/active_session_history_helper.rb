...
module ActiveSessionHistoryHelper
  ...
  def session_statistics_key_rules
    ...
    unless @session_statistics_key_rules_hash
      ...
      @session_statistics_key_rules_hash["Module"]      = {:sql => "TRIM(s.Module)",      :sql_alias => "module",             :Name => 'Module',        :Title => 'Module', :info_caption => 'Info' }
      @session_statistics_key_rules_hash["Action"]      = {:sql => "TRIM(s.Action)",      :sql_alias => "action",             :Name => 'Action',        :Title => 'Action', :info_caption => 'Info' }
