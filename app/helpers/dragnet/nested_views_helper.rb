# encoding: utf-8
module Dragnet::NestedViewsHelper
  ...
  def nested_views
    [
        {
            :name  => t(:dragnet_helper_97_name, :default=>'Nested views (views with dependency on other views)'),
...
'),
        ...
        {
            :name  => t(:dragnet_helper_98_name, :default=>'SQLs using nested views (views with dependency on other views), evaluation of current SGA'),
...
'),
        ...
        {
            :name  => t(:dragnet_helper_99_name, :default=>'SQLs using nested views (views with dependency on other views), evaluation of AWH History'),
