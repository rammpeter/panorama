...
class TableTest < ActiveSupport::TestCase
  ...
  test "references from and to" do
    ...
    PanoramaConnection.sql_execute("ALTER TABLE #{PanoramaConnection.username}.T1 ADD CONSTRAINT T1_T2_FK FOREIGN KEY(ID2) REFERENCES #{PanoramaConnection.username}.T2(ID2)")
