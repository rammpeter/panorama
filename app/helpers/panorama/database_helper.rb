...
module Panorama::DatabaseHelper
...
public
  ...
  def open_oracle_connection
    ...
    if defined?(RUBY_ENGINE) && RUBY_ENGINE == "jruby"
      ...
      begin
        config = Panorama::ConnectionHolder.connection.instance_variable_get(:@config)  # Aktuelle config, kann reduziert sein auf :adapter bei NullDB
      rescue Exception => e
      ...
      if Panorama::ConnectionHolder.connection.class.name != 'ActiveRecord::ConnectionAdapters::OracleEnhancedAdapter' ||
        ...
        Panorama::ConnectionHolder.establish_connection(
