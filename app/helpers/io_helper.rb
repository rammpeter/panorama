...
module IoHelper
  ...
  def total_io_requests(rec)
    rec.small_read_reqs +  rec.small_write_reqs + rec.large_read_reqs + rec.large_write_reqs
  end
  ...
  def iostat_detail_values_column_options
    ...
    if !defined?(@iostat_detail_values_column_options) || @iostat_detail_values_column_options.nil?
      ...
      @iostat_detail_values_column_options = [
          {:caption=>"Small read (MB/sec.)",      :data=>proc{|rec| fn(secure_div(rec.small_read_megabytes,  rec.sample_dauer_secs),2)},    :title=>"Number of single block MB read per second",             :raw_data=>proc{|rec| secure_div(rec.small_read_megabytes,  rec.sample_dauer_secs)},           :data_title=>proc{|rec| "%t\n#{fn(rec.small_read_megabytes,2)} MB read in time period"}},
          {:caption=>"Small write (MB/sec.)",     :data=>proc{|rec| fn(secure_div(rec.small_write_megabytes, rec.sample_dauer_secs),2)},    :title=>"Number of single block MB written per second",          :raw_data=>proc{|rec| secure_div(rec.small_write_megabytes, rec.sample_dauer_secs)},           :data_title=>proc{|rec| "%t\n#{fn(rec.small_write_megabytes,2)} MB written in time period"}},
          {:caption=>"Large read (MB/sec.)",      :data=>proc{|rec| fn(secure_div(rec.large_read_megabytes,  rec.sample_dauer_secs),2)},    :title=>"Number of multiblock MB read per second",               :raw_data=>proc{|rec| secure_div(rec.large_read_megabytes,  rec.sample_dauer_secs)},           :data_title=>proc{|rec| "%t\n#{fn(rec.large_read_megabytes,2)} MB read in time period"}},
          {:caption=>"Large write (MB/sec.)",     :data=>proc{|rec| fn(secure_div(rec.large_write_megabytes, rec.sample_dauer_secs),2)},    :title=>"Number of multiblock MB written per second",            :raw_data=>proc{|rec| secure_div(rec.large_write_megabytes, rec.sample_dauer_secs)},           :data_title=>proc{|rec| "%t\n#{fn(rec.large_write_megabytes,2)} MB written in time period"}},
          {:caption=>"Total I/O requests/sec.",   :data=>proc{|rec| fn(secure_div(total_io_requests(rec),    rec.sample_dauer_secs),1)},    :title=>"Number of total I/O requests per second (small+large, read+write)", :raw_data=>proc{|rec| secure_div(total_io_requests(rec), rec.sample_dauer_secs)},  :data_title=>proc{|rec| "%t\n#{fn(total_io_requests(rec))} requests in time period"}},
          {:caption=>"Small read requests/sec.",  :data=>proc{|rec| fn(secure_div(rec.small_read_reqs,       rec.sample_dauer_secs),1)},    :title=>"Number of single block read requests per second",       :raw_data=>proc{|rec| secure_div(rec.small_read_reqs,       rec.sample_dauer_secs)},           :data_title=>proc{|rec| "%t\n#{fn(rec.small_read_reqs)} requests in time period"}},
          {:caption=>"Small write requests/sec.", :data=>proc{|rec| fn(secure_div(rec.small_write_reqs,      rec.sample_dauer_secs),1)},    :title=>"Number of single block write requests per second",      :raw_data=>proc{|rec| secure_div(rec.small_write_reqs,      rec.sample_dauer_secs)},           :data_title=>proc{|rec| "%t\n#{fn(rec.small_write_reqs)} requests in time period"}},
          {:caption=>"Large read requests/sec.",  :data=>proc{|rec| fn(secure_div(rec.large_read_reqs,       rec.sample_dauer_secs),1)},    :title=>"Number of multiblock read requests per second",         :raw_data=>proc{|rec| secure_div(rec.large_read_reqs,       rec.sample_dauer_secs)},           :data_title=>proc{|rec| "%t\n#{fn(rec.large_read_reqs)} requests in time period"}},
          {:caption=>"Large write requests/sec.", :data=>proc{|rec| fn(secure_div(rec.large_write_reqs,      rec.sample_dauer_secs),1)},    :title=>"Number of multiblock write requests per second",        :raw_data=>proc{|rec| secure_div(rec.large_write_reqs,      rec.sample_dauer_secs)},           :data_title=>proc{|rec| "%t\n#{fn(rec.large_write_reqs)} requests in time period"}},
          {:caption=>"Wait events/sec.",          :data=>proc{|rec| fn(secure_div(rec.number_of_waits,       rec.sample_dauer_secs),1)},    :title=>"Number of I/O wait events per second",                  :raw_data=>proc{|rec| secure_div(rec.number_of_waits,       rec.sample_dauer_secs)},           :data_title=>proc{|rec| "%t\n#{fn(rec.number_of_waits)} wait events occurred in time period"}},
          {:caption=>"Waiting sessions (Load)",   :data=>proc{|rec| fn(secure_div(rec.wait_time.to_f/1000,   rec.sample_dauer_secs),2)},    :title=>"Average number of waiting sessions",                    :raw_data=>proc{|rec| secure_div(rec.wait_time.to_f/1000,   rec.sample_dauer_secs)},           :data_title=>proc{|rec| "%t\n#{fn(rec.wait_time.to_f/1000)} seconds waited in total in time period"}},
      ]
  ...
  def iostat_filetype_values_column_options
    ...
    if !defined?(@iostat_filetype_values_column_options) || @iostat_filetype_values_column_options.nil?
      ...
      @iostat_filetype_values_column_options = [
          ...
          {:caption=>"Small read load (active sessions)",   :data=>proc{|rec| fn(secure_div(rec.small_read_servicetime,  rec.sample_dauer_secs, 1000),2)},  :title=>"Average number of concurrent sessions waiting for small reads",      :raw_data=>proc{|rec| secure_div(rec.small_read_servicetime,  rec.sample_dauer_secs, 1000)}, :data_title=>proc{|rec| "%t, #{fn(rec.small_read_servicetime.to_f/1000)} seconds waiting for small reads"}},
          {:caption=>"Small write load (active sessions)",  :data=>proc{|rec| fn(secure_div(rec.small_write_servicetime, rec.sample_dauer_secs, 1000),2)},  :title=>"Average number of concurrent sessions waiting for small writes",     :raw_data=>proc{|rec| secure_div(rec.small_write_servicetime, rec.sample_dauer_secs, 1000)}, :data_title=>proc{|rec| "%t, #{fn(rec.small_write_servicetime.to_f/1000)} seconds waiting for small writes"}},
          {:caption=>"Large read load (active sessions)",   :data=>proc{|rec| fn(secure_div(rec.large_read_servicetime,  rec.sample_dauer_secs, 1000),2)},  :title=>"Average number of concurrent sessions waiting for large reads",      :raw_data=>proc{|rec| secure_div(rec.large_read_servicetime,  rec.sample_dauer_secs, 1000)}, :data_title=>proc{|rec| "%t, #{fn(rec.large_read_servicetime.to_f/1000)} seconds waiting for large reads"}},
          {:caption=>"Large write load (active sessions)",  :data=>proc{|rec| fn(secure_div(rec.large_write_servicetime, rec.sample_dauer_secs, 1000),2)},  :title=>"Average number of concurrent sessions waiting for large writes",     :raw_data=>proc{|rec| secure_div(rec.large_write_servicetime, rec.sample_dauer_secs, 1000)}, :data_title=>proc{|rec| "%t, #{fn(rec.large_write_servicetime.to_f/1000)} seconds waiting for large writes"}},
          {:caption=>"Small read latency (ms)",             :data=>proc{|rec| fn(secure_div(rec.small_read_servicetime,  rec.small_read_reqs),2)},          :title=>"Avg. service time for single block reads (milliseconds)",              data_title: proc{|rec| "%t\n#{seconds_explain(secure_div(rec.small_read_servicetime,  rec.small_read_reqs,      1000))}"},    :raw_data=>proc{|rec| secure_div(rec.small_read_servicetime,  rec.small_read_reqs)} },
          {:caption=>"Small write latency (ms)",            :data=>proc{|rec| fn(secure_div(rec.small_write_servicetime, rec.small_write_reqs),2)},         :title=>"Avg. service time for single block writes (milliseconds)",             data_title: proc{|rec| "%t\n#{seconds_explain(secure_div(rec.small_write_servicetime, rec.small_write_reqs,     1000))}"},    :raw_data=>proc{|rec| secure_div(rec.small_write_servicetime, rec.small_write_reqs)} },
          {:caption=>"Small sync read latency (ms)",        :data=>proc{|rec| fn(secure_div(rec.small_sync_read_latency, rec.small_sync_read_reqs),2)},     :title=>"Avg. service time for single block synchronous reads (milliseconds)",  data_title: proc{|rec| "%t\n#{seconds_explain(secure_div(rec.small_sync_read_latency, rec.small_sync_read_reqs, 1000))}"},    :raw_data=>proc{|rec| secure_div(rec.small_sync_read_latency, rec.small_sync_read_reqs)} },
          {:caption=>"Large read latency (ms)",             :data=>proc{|rec| fn(secure_div(rec.large_read_servicetime,  rec.large_read_reqs),2)},          :title=>"Avg. service time for multiblock reads (milliseconds)",                data_title: proc{|rec| "%t\n#{seconds_explain(secure_div(rec.large_read_servicetime,  rec.large_read_reqs,      1000))}"},    :raw_data=>proc{|rec| secure_div(rec.large_read_servicetime,  rec.large_read_reqs)} },
          {:caption=>"Large write latency (ms)",            :data=>proc{|rec| fn(secure_div(rec.large_write_servicetime, rec.large_write_reqs),2)},         :title=>"Avg. service time for multiblock writes (milliseconds)",               data_title: proc{|rec| "%t\n#{seconds_explain(secure_div(rec.large_write_servicetime, rec.large_write_reqs,     1000))}"},    :raw_data=>proc{|rec| secure_div(rec.large_write_servicetime, rec.large_write_reqs)} },
