...
Aims to issues that are inadequately analyzed and presented by other existing tools such as Enterprise Manager.
  ...
  #spec.add_dependency "rails", "= 4.2.6"	# Use exactly this rails version
  spec.add_dependency "rails", "= 4.2.7"	# Use exactly this rails version
  #spec.add_dependency "rails", "= 5.0.0.1"	# Use exactly this rails version
