...
class DbaSgaControllerTest < ActionDispatch::IntegrationTest
  ...
  test "list_sql_optimizer_env with xhr: true" do
    [
  ...
  test "list_db_cache_advice_historic with xhr: true" do
    post '/dba_sga/list_db_cache_advice_historic', :params => {:format=>:html, :instance=> @instance, :time_selection_start=>@time_selection_start, :time_selection_end=>@time_selection_end, :update_area=>:hugo }
  ...
  test "plan_management with xhr: true" do
    ...
    assert_response_success_or_management_pack_violation("list_sql_tuning_advisor_tasks", [:none, :panorama_sampler])
  end
