  ...
  def explain_wait_event(event)
    unless @@wait_events
      @@wait_events = {
          ...
          'resmgr:pq queued'                  => "The session is waiting in the parallel statement queue.\nWait Time is the time the session waited for sufficient parallel query processes to become available to run this session with the requested degree of parallelism",
