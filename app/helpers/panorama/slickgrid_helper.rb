...
module Panorama::SlickgridHelper
...
# Berechnen diverser Column-Parameter
  ...
  def gen_slickgrid(data, column_options, global_options={})
    ...
    raise "gen_slickgrid: Parameter-Type #{data.class.name} found for parameter data, but Array expected" unless data.class == Array || data.class == Panorama::SqlSelectIterator
